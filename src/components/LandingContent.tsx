...
const COPY: Record<'fr' | 'nl', LandingCopy> = {
  fr: {
    ...
    freeItems: [
      'Toute la théorie des 9 thèmes, 731 fiches de cours',
      'Toutes les cartes flash, sans limite',
      'Le catalogue des 214 panneaux belges',
      'Ta banque d\'erreurs personnelle',
      'Une session Turbo par jour + un examen blanc',
      'Tout le permis AM (cyclomoteur), sans limite',
    ],
    premiumTitle: 'Premium',
    premiumBadge: 'Tout débloqué',
    premiumItems: [
      'Les 1 770 questions des 9 thèmes',
      'Examens blancs illimités, sur tous les thèmes',
      'Entraînement Turbo illimité',
      'Le quiz des 10 catégories de panneaux',
      'Toutes tes erreurs, thème par thème',
  ...
  nl: {
    ...
    freeItems: [
      'Alle theorie van de 9 thema\'s, 731 leskaarten',
      'Alle flashcards, zonder limiet',
      'De catalogus met 214 Belgische verkeersborden',
      'Je persoonlijke foutenbank',
      'Eén Turbo-sessie per dag + één proefexamen',
      'Het volledige AM-rijbewijs (bromfiets), onbeperkt',
    ],
    premiumTitle: 'Premium',
    premiumBadge: 'Alles ontgrendeld',
    premiumItems: [
      'De 1 770 vragen van de 9 thema\'s',
      'Onbeperkt proefexamens, in alle thema\'s',
      'Onbeperkt Turbo-training',
      'De quiz over de 10 categorieën verkeersborden',
      'Al je fouten, thema per thema',
