...
export default function Navbar() {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <nav className="hidden lg:flex flex-col items-start fixed left-0 top-0 h-full z-50 py-5 pl-4" style={{ width: 'clamp(180px, 16vw, 260px)', background: '#0F1923', borderRight: '1px solid #16213E' }}>
