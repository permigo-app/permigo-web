...
const NAV_ITEMS: { href: string; labelKey: string; color: string; emoji: string }[] = [
  { href: '/app',     labelKey: 'nav_accueil',  color: '#00B894', emoji: '🏠' },
          ...
          {NAV_ITEMS.map((item) => {
            ...
            return (
              ...
              >
                ...
                {/* Emoji icon — always colorful, brighter when active */}
                <div style={{
                  width: 44, height: 30,
                  borderRadius: 15,
                ...
                <span style={{
                  ...
                  color: active ? item.color : '#5a6b8a',
                }}>
                  {t(item.labelKey)}
                </span>
              </Link>
